 ...
 * @deprecated
 */
class PayumExtensionDeprecatedTest extends  \PHPUnit_Framework_TestCase
{
    /**
     * @test
     */
    ...
    {
        $factory = $this->getMock(GatewayFactoryInterface::class);
        $factory
            ->expects($this->any())
            ->method('getName')
    ...
    {
        $factoryWithEmptyName = $this->getMock(GatewayFactoryInterface::class);
    ...
    {
        $factoryMock = $this->getMock(GatewayFactoryInterface::class);
        $factoryMock
            ->expects($this->any())
            ->method('getName')
        ...
        //guard
        $this->assertNotInstanceOf(PrependExtensionInterface::class, $factoryMock);
    ...
    public function shouldPassContainerToGatewayFactoryPrependMethodIfImplementsPrependFactoryInterface()
    {
        ...
        //guard
        $this->assertInstanceOf(PrependExtensionInterface::class, $factoryMock);
